...
namespace AdventOfCode2018.Day12
{
    class Tasks
    {
        ...
        public static void Task1()
        {
            ...
            int simulateGenerations = 20;

            Setup(potState, generation);            

            for(int i = 0; i < simulateGenerations; i++)
            {
                GenerationChange(potState, generation);
            }
        ...
        private static void Setup(SortedDictionary<int, string> potState, Dictionary<string, string> generation)
        {
        ...
        private static void GenerationChange(SortedDictionary<int, string> potState, Dictionary<string, string> generation)
        {
